    ...
    return (
        <div className={styles.home__data}>
            ...
            <p className={styles.home__description}>
                I am a creative programmer. I develop Android and Web Applications. 
                I am also a passionate competitive programmer. 
            </p>
            <a href="#contact" className={`${styles.button} button--flex`}>
                Say Hello
                <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
